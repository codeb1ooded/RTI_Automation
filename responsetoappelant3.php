	...
	<tr>
		...
		<th><input type="text" name="holder_receipt_date" id="Name" maxlength="50" value="" class="name" placeholder="YYYY-MM-DD"></th>
	</tr>	
	<tr>
		<th>(ii)Date of reply to appellant/complaint by CPIO</th>
		<th><input type="text" name="reply_date" id="Name" maxlength="50" value="" class="name" placeholder="YYYY-MM-DD"></th></tr>
	<tr>
	<tr>
		<th>Mode of communicating reply </th><th>
		<input type="text" name="reply_mode" id="Name" maxlength="50"></th>
	</tr>
		<th>Whether name and address of FAA mentioned in the</br> reply u/s 7(8)(give particulars)</th>
		<th><input type="text" name="faa_info" id="Name" maxlength="50" value="" class="name" placeholder=""></th>
	</tr>
